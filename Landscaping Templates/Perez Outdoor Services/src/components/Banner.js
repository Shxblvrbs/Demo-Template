      ...
      <div className='container mx-auto'>
        <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12'>
          ...
          <div className='flex-1 text-center font-secondary lg:text-left'>
            ...
            >
              Perez  <span>Outdoor Services</span>
            </motion.h1>
            <motion.div
            ...
            >
              Serving the larger DC, Maryland, and Virginia metropolitan for over 10+ years.
            </motion.p>
            <motion.div
            ...
            >
              <button className='btn btn-lg'><a href="tel: +15405229302">Call Me For a Free Estimate!</a></button>
              {/* <Link
                to='about'
                activeClass='active'
                smooth={true}
